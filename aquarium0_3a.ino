...
Void chillerOff(){
	//digitalWrite(, LOW;)
	Serial.print("chillerOff");
}

Void chillerOn(){
	//digitalWrite(, HIGH;)
	Serial.print("chillerOn");
}
...
Void carbonReactorOn(){
	//digitalWrite(, HIGH;)
	Serial.print("carbonReactorOn");
}

Void carbonReactorOff(){
	//digitalWrite(, LOW;)
	Serial.print("carbonReactorOff");
}

Void phosbanReactorOn(){
	//digitalWrite(, HIGH;)
	Serial.print("phosbanReactorOn");
}

Void phosbanReactorOff(){
	//digitalWrite(, LOW;)
	Serial.print("phosbanReactorOff");
}

Void calciumReactorOn(){
	//digitalWrite(, HIGH;)
	Serial.print("calciumReactorOn");
}

Void calciumReactorOff(){
	//digitalWrite(, LOW;)
	Serial.print("calciumReactorOff");
}

void refugiumLightOn(){
	//digitalWrite(, HIGH;)
	Serial.print("refugiumLightOn");
}

void refugiumLightOff(){
	//digitalWrite(, LOW;)
	Serial.print("refugiumLightOff");
}
...
void algaeTurfScrubberOn(){//Light and Pump
	//digitalWrite(, HIGH;)
	//digitalWrite(, HIGH;)
	Serial.print("algaeTurfScrubberOn");
}

void algaeTurfScrubberOff(){//Light and Pump
	//digitalWrite(, LOW;)
	//digitalWrite(, LOW;)
	Serial.print("algaeTurfScrubberOff");
}
